...
export const GET_POST_CLICKED_REQUEST = "GET_POST_CLICKED_REQUEST";
export const GET_POST_CLICKED_SUCCESS = "GET_POST_CLICKED_SUCCESS";
export const GET_POST_CLICKED_FAILURE = "GET_POST_CLICKED_FAILURE";
